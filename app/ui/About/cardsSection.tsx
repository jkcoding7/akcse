...
export default function CardsSection() {
  ...
  const cards = [
    ...
    },
    {
      ...
      content:
        "The Local Chapter of AKCSE covers each participating province in Canada, allowing members all around the province to join AKCSE, regardless of their education level or career stage. On top of university students and professionals in their early career stages, the Local Chapter welcomes members who have further progressed in their career, including professors, researchers and senior-level professionals. These members are the foundation of the mentoring that AKCSE provides for its members, as they can share countless years of expertise and foresight with YP and YG members. Members of the local chapters can network with each other, as well as with other members in different provinces, allowing for the exchange of information that benefits both sides in terms of culture, education, and career.",
    },
  ];
